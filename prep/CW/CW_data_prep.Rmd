...
In this document, we'll walk through the general steps we recommend you include in your own prep document, including:
...
=======
data1 = read_csv(file.path(dir_cw, 'example_data', 'ices_secchi.csv'))
>>>>>>> 5fbf244b65c40ef8bff1c9c403d1d6bf1bd55504
...
## read in smhi set
<<<<<<< HEAD
data2 = read_csv(file.path(dir_cw, 'example_data', 'smhi_secchi.csv'))
=======
